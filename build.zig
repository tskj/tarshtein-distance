...
pub fn build(b: *std.Build) void {
    ...
    // below:
    // is yanked from here https://github.com/JacobCrabill/ziglets/blob/19e03d47d1731e792c67be0c6cafc09ecc8e8776/lua-module/build.zig
    ...
    const copy_step = b.addInstallFileWithDir(zig_mod.getEmittedBin(), .lib, "levvy.so");
